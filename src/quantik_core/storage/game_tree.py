...
class GameState:
    ...
    def apply_move(self, move: Move) -> "GameState":
        ...
        # Convert to tuple for GameState constructor
...
class GameTree:
    ...
    def add_node(
        self, state: GameState, value: float, moves: Optional[List[Move]] = None
    ) -> None:
        """
        Add node to tree.
    ...
    def save_checkpoint(self, filename: str, compress: bool = True) -> None:
        ...
        checkpoint = {"data": compact_data, "stats": self._stats}
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            **self._stats,
            ...
            "memory_usage_mb": len(self._nodes)
            * 104
            / (1024 * 1024),  # Tuples in memory
        }
