...
Python currently declares support for contracts release `1.3.0` via
...
- `contract_version`, when present, is `1.3.0`.
...
fixture through `mberlanda/quantik-core-contracts/actions/validate-contracts@v1.3.0`.
...
3. Contracts: validate fixtures through `mberlanda/quantik-core-contracts/actions/validate-contracts@v1.3.0`.
