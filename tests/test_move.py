...
class TestLegalMoveGeneration:
    ...
    def test_empty_board_legal_moves(self):
        ...
        moves_list = generate_legal_moves_list(state)
    ...
    def test_opponent_same_shape_constraint_column(self):
        ...
        state = State.from_qfen("B.../..../..../....", validate=True)
        current_player, moves_by_shape = generate_legal_moves(state)
    ...
    def test_opponent_same_shape_constraint_zone(self):
        ...
        state = State.from_qfen("C.../..../..../....", validate=True)
        current_player, moves_by_shape = generate_legal_moves(state)
    ...
    def test_occupied_position_constraint(self):
        ...
        state = State.from_qfen("AB../c.../d.../....", validate=True)
        current_player, moves_by_shape = generate_legal_moves(state)
    ...
    def test_endgame_few_legal_moves(self):
        ...
        state = State.from_qfen("AB.D/d.cb/AB../c.d.", validate=True)
        current_player, moves_by_shape = generate_legal_moves(state)
...
class TestCountPiecesByPlayerShape:
    ...
    def test_empty_board_count(self):
        ...
        state = State.empty()
        player0_counts, player1_counts = count_pieces_by_player_shape(state)
    ...
    def test_multiple_pieces_count(self):
        ...
        state = State.from_qfen("Ab../cD../..../....", validate=True)
        player0_counts, player1_counts = count_pieces_by_player_shape(state)
